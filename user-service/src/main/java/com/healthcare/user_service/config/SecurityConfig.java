...
import com.healthcare.user_service.security.CustomUserDetailService;
import com.healthcare.user_service.security.JwtAuthenticationEntryPoint;
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET).permitAll() // Allow access to Http GET endpoints
